...
else
{
	...
	if(!is_null($dealerhead) && $dealerhead != '') {
    	$query = "select * from inv_dealercard left join inv_mas_scratchcard on inv_dealercard.cardid = inv_mas_scratchcard.cardid where (inv_dealercard.sub_dealer = '$userid' OR inv_dealercard.dealerid = '$userid')";
	}
	//echo $query;
	#Added on 06/03/2018 Ends
...
<script language="javascript" src="../functions/dealerpincardattach.js?dummy=<?php echo (rand());?>"></script>
<script language="javascript" src="../functions/dealerpinattach.js?dummy=<?php echo (rand());?>"></script>
...
<td width="63%" align="left" colspan="2" valign="top" bgcolor="#EDF4FF" id="displaycustomername">&nbsp;</td>
                                          ...
                                          <tr bgcolor="#f7faff">
                                            <td colspan="2" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                              <tr>
                                              <td width="20%"><strong>Item Product</strong>: </td>
                                                  <td width="28%"><select name="product" class="swiftselect" id="product" style="width:195px;" onchange="getpin(this.value);">
                                                      <option value="" selected="selected">Select a Item</option>
                                                      <?php 
                                                      include('../inc/productattach.php');
                                                      ?>
                                                    </select>
                                                    </td>
                                              </tr>
                                              <tr>
                                              <td width="20%"><strong>Purchase Type</strong>: </td>
                                              <td width="28%"><select name="purtype" id="purtype" class="swiftselect" onchange="getpindetails(this.value);">
                                              ...
                                              <tr>
                                                <td width="29%" height="34px;" ><strong>Select a PIN :</strong></td>
                                              ...
                                              <tr>
                                                <td colspan="2"><div id="dispreregcardlist">
                                                              ...
                                                              <div align="left">
                                                                <input name="searchscratchnumber" type="text" class="swifttext" id="searchscratchnumber"  style="width:191px" autocomplete="off" onkeyup="reg_cardsearch(event);"/><!-- onkeyup="reg_cardsearch(event);" -->
                    ...
                    <!--onclick="reg_selectcardfromlist();scratchdetailstoform(document.getElementById('scratchcardlist').value);"  -->                                          </select>
                                                      </div>
                                                  </div></td>
                                              </tr>
                                            </table></td>
