...
$relyonexecutive = $result['relyonexecutive'];
...
<script language="javascript" src="../functions/dealerpayment.js?dummy = <?php echo (rand());?>" type="text/javascript"></script>
                                      ...
                                      <td><table width="100%" border="0" cellpadding="2" cellspacing="0">
                                          ...
                                          <tr>
                                            ...
                                            <input name="businessname" type="hidden" id="businessname" value="<?php echo($businessname); ?>" />
                                              ...
                                              <input name="amount" type="text" class="swifttext" id="amount" value="" size="25" maxlength="7" autocomplete ="off"  /></td>
                                          </tr>
                                        </table>
