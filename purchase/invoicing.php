<?php
//echo "Invoicing will be active by 2.30PM 23 March 2017, webmaster@relyonsoft.com";
//exit();
                                                  ...
                                                  <tr>
                                                    <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                                                                ...
                                                                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                                    ...
                                                                    <tr>
                                                                      <td><label for="databasefield8">
                                                                          <input type="radio" name="modeofpayment" id="databasefield8" value="upi"  onclick="showhidepaymentdiv();"/>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td width="36%"><div align="right" style="display:none1;">
                                                              <input type="checkbox" name="invoicedated" id="invoicedated" onclick="calculatenormalprice();"/><!--  onclick="calculatenormalprice();" -->
                                                              Invoice Dated 31-03-2019 </div></td>
                                                        </tr>
                                                        <tr>
                                                          <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                              <tr>
                                      ...
                                      <td colspan="2"><table width="98%" cellspacing="0" cellpadding="4" border="0" class="table-border-grid">
                                          <tbody>
                                           ...
                                           <tr>
                                              ...
                                              <td width="49%" class="td-border-grid" style="text-align: left;"><strong>GSTIN:</strong> 29AABCR7796N1ZC</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                            <td class="td-border-grid" style="text-align: left;" colspan="2"><strong>Pan No:</strong> &nbsp; <span id="pannopreview"></span></td>
