...
function rslmail($fromname, $fromemail, $toarray, $subject, $text, $html, $ccarray = null,  $bccarray, $filearray=null, $replyto = '')
{
	...
	// $smtp = 'server.relyonsoft.com';
	//  $username = 'imax@relyon.co.in';
	//  $password = 'itzzzimax';
	// $smtp = 'smtp.mailgun.org';
	// $username = 'saralgst@email.sppcloud.com';
	 //$password = '4598c7c8ef9e7f4f86a9a429b6c788e9-4f207195-eb90941c';
   
// $username = 'saralgst@demo.paycalci.com';
// $password = '433770d6598e258745092ce278377788-4f207195-da456972';
 //$smtp_port = 25;
//  $smtp_port = 587;
//  $usessl = false;
//  $timeout = 30;
...
$smtp = 'email-smtp.us-east-1.amazonaws.com';
	 $username = 'AKIASFIP23VQBD5M3XM6';
	 $password = 'BFfVGDrPVsuyKJ5xOosbvxQoPhH017J6e2LymTWLbXDC';
	 $smtp_port = 465;
	 $usessl = true;
	 $timeout = 30;
	 $fromemail = "noreplyimax@sppcloud.com";
