function validatehandholdcheckboxes()
{
var chksvalue = $("input[name='handhold[]']");
...
function formsubmit()
{
	...
	// var values = validatehandholdcheckboxes();
	// if(values == false)	{error.html(errormessage("Select Atleast one Hand Hold Type"));  return false;	}
	...
	{
		error.html('');
		$('#submitform').attr("action", "../reports/handholdstatus.php") ;
