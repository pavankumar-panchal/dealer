...
function formsubmit(command)
{
	...
	else
	{
		...
		// {
			error.html('');
			form.attr('action','../reports/exceldealerreport.php');
...
function disableregistration()
{
	...
	{
		$('#registered').val('');
		$('#registered').attr('disabled',true).css('background-color', 'grey');
	}
	else
		$('#registered').attr('disabled',false).css('background-color', '');
}
