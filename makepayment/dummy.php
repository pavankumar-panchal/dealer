...
$onlineslno = $_POST['onlineslno'];
$recordreferencestring = $onlineslno ;
...
if($ResponseCode == 0) //Success
{
	...
	//	$bccarray = array('Bigmail' => 'bigmail@relyonsoft.com', 'Accounts' => 'accounts@relyonsoft.com', 'Vijay' => 'vijaykumar@relyonsoft.com', 'Webmaster' => 'webmaster@relyonsoft.com'); 
                      ...
                      <td ><table width="100%" border="0" cellspacing="0" cellpadding="5"  >
                          ...
                          <tr>
                            <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" id="paymentbg">
                                <tr>
                                  ...
                                  <td width="39%" class="subfonts"><div align="right"><img src="../images/relyon-logo.jpf" width="106" height="37" border="0" style="border:solid 2px #9aaed2"/></div></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td width="35%"><div align="center">
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <input type="button" id="update" name="update" value="Go to Home Page"   />
                              </div></td>
                          </tr>
                        </table></td>
                    </tr>
