...
<script language="javascript" src="../functions/handholdstatus.js?dummy=<?php echo (rand());?>"></script>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          <tr>
                            <td  class="active-leftnav1">Report - Hand Hold Implementation Detailed</td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
                                      ...
                                      <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                          ...
                                          <tr bgcolor="#EDF4FF">
                                            <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
                                              <tr>
                                                <td width="5%"><input type="checkbox" name="selectproduct" id="selectproduct" onchange="selectdeselectcommon('selectproduct','productname[]')" /></td>
                                                <td width="95%"><label for="selectproduct">Select All / None</label></td>
                                              </tr>
                                            </table></td>
                                          </tr>
                                          <tr bgcolor="#f7faff">
                                            <td colspan="2" valign="top" bgcolor="#EDF4FF" align="left"><strong>Hand Hold Type</strong></td>
                                          </tr >
                                          <tr bgcolor="#f7faff" >
                                            
                                            <td colspan="2" valign="top" bgcolor="#f7faff" align="left"><div style="height:110px; overflow:scroll">
                                                <?php include('../inc/imp-handhold.php'); ?>
                                              </div></td>
                                          </tr>
                                          <tr bgcolor="#EDF4FF">
                                            <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
                                              <tr>
                                                <td width="5%"><input type="checkbox" name="selecthandhold" id="selecthandhold" checked="checked" onchange="selectdeselectcommon('selecthandhold','handhold[]')" /></td>
                                                <td width="95%"><label for="selecthandhold">Select All / None</label></td>
                                              </tr>
                                            </table></td>
                                          </tr>
