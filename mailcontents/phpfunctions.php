...
function vieworgeneratepdfinvoice111($slno,$type)
{
	...
	while($fetch = mysqli_fetch_array($result))
	{
		...
		$grid .= '<tr><td colspan="2" style="text-align:right" width="86%"><strong>Total</strong></td><td  width="14%" style="text-align:right">'.$fetch['amount'].$appendzero.'</td></tr><tr><td  width="56%" style="text-align:left"><span style="font-size:+6" >'.$fetch['servicetaxdesc'].$appendzero.' </span></td><td  width="30%" style="text-align:right"><strong>Service Tax @ 12.3%</strong></td><td  width="14%" style="text-align:right">'.$fetch['servicetax'].$appendzero.'</td></tr><tr><td  width="56%" style="text-align:right"><div align="left"><span style="font-size:+6" >E.&amp;O.E.</span></div></td><td  width="30%" style="text-align:right"><strong>Net Amount</strong></td><td  width="14%" style="text-align:right"><img src="http://www.relyonsoft.com/imax/images/relyon-rupee-small.jpg" alt="Relyonsoft" width="8" height="8" border="0" align="absmiddle"  />&nbsp;&nbsp;'.$fetch['netamount'].$appendzero.'</td> </tr><tr><td colspan="3" style="text-align:left"><strong>Rupee In Words</strong>: '.$fetch['amountinwords'].' only</td></tr>';
	  }
...
function vieworgeneratepdfinvoice_backup($slno,$type)
{
	...
	while($fetch = mysqli_fetch_array($result))
	{
		...
		$grid .= '<tr><td  width="56%" style="text-align:left"><span style="font-size:+6;color:#FF0000" >'.$statusremarks.' </span></td><td  width="30%" style="text-align:right"><strong>Total</strong></td><td  width="14%" style="text-align:right">'.$fetch['amount'].$appendzero.'</td></tr><tr><td  width="56%" style="text-align:left"><span style="font-size:+6" >'.$fetch['servicetaxdesc'].' </span></td><td  width="30%" style="text-align:right"><strong>Service Tax @ 12.3%</strong></td><td  width="14%" style="text-align:right">'.$fetch['servicetax'].$appendzero.'</td></tr><tr><td  width="56%" style="text-align:right"><div align="left"><span style="font-size:+6" >E.&amp;O.E.</span></div></td><td  width="30%" style="text-align:right"><strong>Net Amount</strong></td><td  width="14%" style="text-align:right"><img src="http://www.relyonsoft.com/imax/images/relyon-rupee-small.jpg" alt="Relyonsoft" width="8" height="8" border="0" align="absmiddle"  />&nbsp;&nbsp;'.$fetch['netamount'].$appendzero.'</td> </tr><tr><td colspan="3" style="text-align:left"><strong>Rupee In Words</strong>: '.$fetch['amountinwords'].' only</td></tr>';
	//	echo($grid1); exit;
	//	$grid .= '<tr><td colspan="2" style="text-align:right" width="86%"><strong>Total</strong></td><td  width="14%" style="text-align:right">'.$fetch['amount'].$appendzero.'</td></tr><tr><td  width="56%" style="text-align:left"><span style="font-size:+6" >'.$fetch['servicetaxdesc'].$appendzero.' </span></td><td  width="30%" style="text-align:right"><strong>Service Tax @ 10.3%</strong></td><td  width="14%" style="text-align:right">'.$fetch['servicetax'].$appendzero.'</td></tr><tr><td  width="56%" style="text-align:right"><div align="left"><span style="font-size:+6" >E.&amp;O.E.</span></div></td><td  width="30%" style="text-align:right"><strong>Net Amount</strong></td><td  width="14%" style="text-align:right"><img src="http://www.relyonsoft.com/imax/images/relyon-rupee-small.jpg" width="8" height="8" border="0" align="absmiddle"  />&nbsp;&nbsp;'.$fetch['netamount'].$appendzero.'</td> </tr><tr><td colspan="3" style="text-align:left"><strong>Rupee In Words</strong>: '.$fetch['amountinwords'].' only</td></tr>';
	  }
...
<td  width="14%" style="text-align:right"><img src="http://www.relyonsoft.com/imax/images/relyon-rupee-small.jpg" alt="Relyonsoft" width="8" height="8" border="0" align="absmiddle"  />&nbsp;&nbsp;'.formatnumber($fetch['netamount']).$appendzero.'</td> 
...
;
	...
	if($filebasename <> '')
	{
		...
		//Relyon Logo for email Content, as Inline [Not attachment]
		$filearray = array(
			array('../images/relyon-logo.jpg','inline','1234567890'),array('../filecreated/'.$filebasename,'attachment','1234567891'),array('http://www.relyonsoft.com/imax/images/relyon-rupee-small.jpg','inline','1234567892')
		);
...
function viewreceipt($receiptno,$type)
{
	...
	if($result1['paymentmode'] == 'chequeordd' )
		$remarks = '<span> Cheque/DD No: '.$result1['chequeno'].' dated '.changedateformat($result1['chequedate']).', drawn on '.$result1['drawnon'].', for amount <img src="http://www.relyonsoft.com/imax/images/relyon-rupee-small.jpg" alt="Relyonsoft" width="8" height="8" border="0" align="absmiddle" /> '.$result1['receiptamount'].'. Cheques received are subject to realization.</span>';
...
function sendreceipt($receiptno,$type)
{
	...
	if($filebasename <> '')
	{
		...
		if($type == 'resend')
		{
			$filearray = array(
				array('../images/relyon-logo.jpg','inline','1234567890'),
				array('../filecreated/'.$filebasename,'attachment','1234567891'),array('http://www.relyonsoft.com/imax/images/relyon-rupee-small.jpg','inline','1234567892')
			);
		}
		elseif($type == 'cancelled')
		{
...
{       
  ...
  $grid="<tr>";
    ...
    for($i=0;$i<count($descriptionsplit);$i++)
    {
      ...
      <span style="font-size:12px;" ><strong id="space">Purchase Type</strong> : '.$descriptionline[2].'&nbsp;&nbsp;<br/><strong id="space">Usage Type</strong> :'.$descriptionline[3].'&nbsp;&nbsp;<br/><span style="font-size:12px" ><strong id="space">Product Description</strong> : '.$productdesvalue.' </span><br/><strong id="space">Finalcial Year:</strong>'.$financial_year.'</td>';
          $grid .= '<td  width="12%" style="text-align:right;" >'.formatnumber($descriptionline[6]).$appendzero.'</td></tr>';
    ...
    if($fetch1['servicedescription'] <> '')
    {
      for($i=0; $i<$servicedescriptioncount; $i++)
      {
        ...
        $grid .= '<tr >';
        $grid .= '<td  width="10%" style="text-align:centre;">'.$count.'</td>';
        $grid .= '<td   width="78%" style="text-align:left;">'.$servicedescriptionline[1].'<br/><span style="font-size:12px" ><strong>   Item Description</strong> : '.$itemdesvalue.' </span></td>';
...
<td  width="12%" style="text-align:right"><img src="http://www.relyonsoft.com/imax/images/relyon-rupee-small.jpg" alt="Relyonsoft" width="8" height="8" border="0" align="absmiddle"  />&nbsp;&nbsp;'.formatnumber($fetch1['netamount'] ).$appendzero.'</td> 
</tr>
...
$grid.='<br/><br/><center><a class="myButton" id="myButton" href="http://imax.relyonsoft.com/api/sppnewupdatepurchase/index.php?Qa1iio9='.$pinv_cus_id1.'&AsWrIo='.$p_slno1.'" target="_blank" class="myButton">Pay Now</a></center>';
$msg.=$grid;
...
//End of invoice template
  ...
  $filearray = array(
    ...
    //array('../images/customer-service.gif','inline','22222222222'),
    array('../images/relyon-logo.jpg','inline','8888888888'),
    //array('http://www.relyonsoft.com/imax/images/relyon-rupee-small.jpg','inline','66666666666')   
  );
